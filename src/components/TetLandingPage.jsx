...
const TetLandingPage = () => {
  ...
  const closeLightbox = () => {
    ...
    setCurrentImage('');
    setCurrentImageAlt('');
    document.body.style.overflow = 'unset'; // Cho phép scroll lại
  };
      ...
      <section id="gallery" className="py-16 md:py-32 relative">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 gap-4 md:hidden">
            <div className="rounded-2xl overflow-hidden relative group h-64 cursor-pointer" onClick={() => openLightbox('/IMG_2120.JPG', 'Áo Dài Studio')}>
              <img 
                src="/IMG_2120.JPG"
                alt="Áo Dài Studio"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-2xl overflow-hidden relative group h-48 cursor-pointer" onClick={() => openLightbox('/IMG_2121.JPG', 'Áo dài truyền thống')}>
                <img 
                  src="/IMG_2121.JPG"
              ...
              <div className="rounded-2xl overflow-hidden relative group h-48 cursor-pointer" onClick={() => openLightbox('/IMG_2122.JPG', 'Áo dài truyền thống')}>
                <img 
                  src="/IMG_2122.JPG"
                  alt="Áo dài truyền thống"
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
            ...
            <div className="rounded-2xl overflow-hidden relative group h-64 cursor-pointer" onClick={() => openLightbox('/IMG_2123.JPG', 'Áo dài truyền thống')}>
              <img 
                src="/IMG_2123.JPG"
                alt="Áo dài truyền thống"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
          ...
          <div className="hidden md:grid grid-cols-2 md:grid-cols-4 gap-4 h-[500px]">
            <div className="col-span-2 row-span-2 rounded-2xl overflow-hidden relative group cursor-pointer" onClick={() => openLightbox('/IMG_2120.JPG', 'Áo Dài cổ phục')}>
              <img 
                src="/IMG_2120.JPG"
                alt="Áo Dài cổ phục"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
              ...
              <div className="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors duration-300 flex items-end p-6">
                <p className="text-white font-serif-display text-2xl italic">Áo Dài cổ phục</p>
              </div>
            ...
            <div className="col-span-1 row-span-1 rounded-2xl overflow-hidden relative group cursor-pointer" onClick={() => openLightbox('/IMG_2121.JPG', 'Áo dài truyền thống')}>
              <img 
                src="/IMG_2121.JPG"
                alt="Áo dài truyền thống"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
            ...
            <div className="col-span-1 row-span-2 rounded-2xl overflow-hidden relative group cursor-pointer" onClick={() => openLightbox('/IMG_2123.JPG', 'Áo dài truyền thống')}>
              <img 
                src="/IMG_2123.JPG"
                alt="Áo dài truyền thống"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
             ...
             <div className="col-span-1 row-span-1 rounded-2xl overflow-hidden relative group cursor-pointer" onClick={() => openLightbox('/IMG_2122.JPG', 'Áo dài truyền thống')}>
              <img 
                src="/IMG_2122.JPG"
                alt="Áo dài truyền thống"
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
          ...
          <div className="relative max-w-4xl max-h-full w-full h-full flex items-center justify-center">
            ...
            <div className="absolute bottom-4 left-4 right-4 text-center">
              <div className="bg-black/50 backdrop-blur-sm rounded-lg px-4 py-2 inline-block">
                <p className="text-white font-serif-display text-lg">{currentImageAlt}</p>
              </div>
            </div>
          </div>
        </div>
